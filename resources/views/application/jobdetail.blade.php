...
@section('content')
    <div class="content">
        <div class="d-flex justify-content-between mx-5 mt-5 px-5">
            <div>
                <h5 class="fw-bold"><i class="fas fa-arrow-left fa-xs me-2"></i>DETAIL
                    LOWONGAN</h5>
            </div>
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="/lowongan" class="text-secondary">Daftar
                                Lowongan</a></li>
        ...
        <div class="d-flex mx-5 mt-5 px-5">
            <div class="w-75 me-4">
                ...
                <div class="mt-4">
                    ...
                    <ul class="mb-5">
                        <li>Membuat dan mendesain berbagai materi untuk media cetak dan
                            digital</li>
                        <li>Membangun komunikasi visual yang kuat</li>
                        <li>Bekerja sama dengan divisi pemasaran</li>
                        <li>Menetapkan arahan kreatif untuk perusahaan serta pedoman
                            merek</li>
                        <li>Memastikan hasil akhir grafis dan tata letak menarik secara
                            visual dan sesuai merek</li>
                        ...
                        <li>Perhatian yang tinggi terhadap detail dan rasa estetika
                            desain</li>
                        <li>Mampu menerjemahkan desain singkat ke hasil visual yang
                            sebenarnya</li>
                    ...
                    <div class="d-flex">
                        <div class="me-5">
                            ...
                            <p class="mb-4">SMK sederajat, D1/2/3, S1/S2, Professional
                                bersertifikasi.</p>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <button class="btn bg-primary text-white py-3 px-4 roundedpill">
            ...
            <div style="width: 350px">
                <div class="mt-5 p-4 bg-light rounded">
                    ...
                    <div>
                        ...
                        <button class="btn bg-light-2 rounded-pill py-1 px-3">Pelajari
                            selengkapnya</button>
                        <hr>
                    </div>
                    <div>
