            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Daftar
                            Lowongan</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="d-flex mx-5 mt-2 px-5">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            <input type="text" class="form-control" aria-label="search"
                                placeholder="Ketik jenis keahlian / posisi / nama perusahaan">
            ...
            <div>
                <button class="rounded-pill px-5 py-3 bg-primary btn text-white" style="width: 350px" data-bs-toggle="modal"
                    data-bs-target="#formModal"><i class="fas fa-plus me-2"></i>TAMBAH
                    LOWONGAN</button>
                <div class="mt-5 p-4 bg-light rounded">
                    <h5 class="fw-bold">Filter</h5>
                    <form action="" class="mt-3">
                        <div class="mb-3">
                            <label for="relevansi" class="form-label">Urutkan
                                menurut</label>
                        ...
                        <div class="mb-3">
                            <label for="tipePekerjaan" class="form-label">Tipe
                                pekerjaan</label>
                            <select class="form-select">
