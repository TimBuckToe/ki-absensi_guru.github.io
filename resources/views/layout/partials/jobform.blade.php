        ...
        <div class="modal-content p-3">
            <div class="modal-header p-2 align-items-center">
                <div class="d-flex flex-column justify-content-center w-100 align-items-center">
                    <img src="{{ url('assets/img/logo.png') }}" width="50px" alt="AL Ittihad" class="" />
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <label for="recipient-name" class="col-form-label">Ukuran
                                perusahaan</label>
                            <select class="form-select">
                    ...
                    <hr class="mt-4 mb-5">
                    <div class="mb-3 mt-3">
                        <label for="recipient-name" class="col-form-label">Judul
                            lowongan pekerjaan</label>
                        <input type="text" class="form-control" id="title">
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Deskripsikan
                            tugas pada lowongan ini</label>
                        <textarea class="form-control" id="description"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="message-text" class="col-form-label">Tunjangan &
                            keuntungan</label>
                        <input type="text" class="form-control" id="benefit">
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Perkiraan
                            gaji untuk lowongan ini</label>
                        <select class="form-select">
                    ...
                    <div class="mb-3">
                        <label for="message-text" class="col-form-label">Skill yang
                            harus dikuasai</label>
                        <input type="text" class="form-control" id="skill">
                    </div>
                    <div class="mb-3 row">
                        <label for="Kategori" class="form-label">Tingkat
                            pendidikan</label>
                        <div class="col">
                            <div class="mb-3">
                ...
                <button type="button" class="btn bg-primary rounded-pill w-100 textwhite py-2 mt-3">SIMPAN &
                    PUBLISH</button>
                <button type="button" class="btn btn-outline-warning py-2 mt-3 w-100 rounded-pill">SIMPAN LALU TAMBAH
                    BARU</button>
            </div>
        </div>
    </div>
